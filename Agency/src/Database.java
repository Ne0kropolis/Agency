...
public class Database {
    ...
    public void rebuild() {
        ...
        try {
            ...
            /**CREATE TABLES**/
            stmnt.executeUpdate("CREATE TABLE CUSTOMER (custNumber NUMBER(9), firstName VARCHAR(40), surName VARCHAR(40), " +
                    "canRent CHAR(1))");

            stmnt.executeUpdate("CREATE TABLE VEHICLE (vehNumber NUMBER(9), make VARCHAR(40), category VARCHAR(10), " +
                    "rentalPrice FLOAT(6), availableForRent CHAR(1))");

            stmnt.executeUpdate("CREATE TABLE RENTAL (rentalNumber NUMBER(9), dateRental DATE, " +
